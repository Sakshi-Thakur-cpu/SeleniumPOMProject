...
public class RegisterPage {
	...
	String registerTitle=eleUtil.waitForTitleContainsAndReturn(AppConstants.REGISTER_PAGE_TITLE, AppConstants.DEFAULT_SHORT_TIMEOUT);
	...
	public boolean userRegisteration(String firstName, String lastName, String email, String telephone, 
		...
		String successMesg = eleUtil.waitForElementVisible(successMessg, AppConstants.DEFAULT_MEDIUM_TIMEOUT).getText();
